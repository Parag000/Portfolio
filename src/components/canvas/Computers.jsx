  ...
  return (
    <mesh>
      <hemisphereLight intensity={0.5}
        groundColor="black" />
      <pointLight intensity={0} />{/*this is the pointlight that appears in the screen. Its almost like the pointlight is an eye. */}
      <spotLight
        position={[-20, 50, 10]}//it makes the light stays almost at the top of the pc.
        angle={0.12}//not so sure what it does...
        penumbra={10}//like a gradient
      ...
      <primitive
        ...
        position={isMobile ? [0, -3, -2.2] : [0, -3.75, -1.5]}//this is te position he is on the screen. x, y, z
        rotation={[-0.01, -0.25, -0.1]}//this is the rotation x y z for the computer
      />
